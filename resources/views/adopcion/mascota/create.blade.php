...
@section('content')
    ...
    @endpush
    <form class="needs-validation" novalidate="" action="{{ route('mascota.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function() {
                document.getElementById("about").defaultValue = "{{ old('about') }}"
                $('#etiqueta').select2({
