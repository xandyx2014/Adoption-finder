                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                @if(Illuminate\Support\Str::contains($publicacion['imagens'][0]['url'], 'http'))
                                    <img class="img-thumbnail" src='{{ asset( $publicacion['imagens'][0]['url'] ) }}' alt="" srcset="">
                                @else
                                    <img style="width: 50%" class="img-thumbnail" src='{{ asset( "storage/" . $publicacion['imagens'][0]['url'] ) }}' alt=""
                                         srcset="">
                                @endif
                            ...
                            <td>
                                <a target="_blank" href="{{ route('publicacion.show', $publicacion->id) }}"
                                   class="btn btn-success">Ver publicacion</a>
                                <br>
                                @if($publicacion->estado)
                                    <a target="_blank" href="{{ route('blog.show', $publicacion->id) }}"
                                       class="btn btn-outline-success mt-2">Ver en Blog <i class="fa fa-newspaper-o"
                            ...
                            <td>
                               {{-- <a class="btn btn-success">
                                ...
                                <a href="{{ route('imagenPublicacion.edit', $publicacion->id) }}" class="btn btn-warning">
